...
var client = require('./client-429cfaee.js');
var React = _interopDefault(require('react'));
var PropTypes = _interopDefault(require('prop-types'));
var Cookies = _interopDefault(require('react-cookies'));
require('./base-bdd9c13b.js');
var socketio = require('./socketio-f30d3dc9.js');
require('./master-ff61b102.js');
  ...
  return _temp = _class = /*#__PURE__*/function (_React$Component) {
    ...
    reducer._createClass(WrappedBoard, [{
      ...
      value: function render() {
        ...
        if (board) {
          _board = React.createElement(board, reducer._objectSpread2(reducer._objectSpread2(reducer._objectSpread2({}, state), this.props), {}, {
